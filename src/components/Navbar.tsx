        ...
        <div className="nav-actions-desktop" style={{
          ...
          <a href="#contact" style={{
            ...
            onMouseEnter={e => {
              ...
              (e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 4px 20px rgba(79,70,229,0.35)';
            }}
            onMouseLeave={e => {
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, paddingTop: 16 }}>
            ...
            <a href="#contact" onClick={() => setMenuOpen(false)} style={{
              padding: '8px 20px', borderRadius: 999,
              background: 'var(--gradient)', color: '#fff',
              fontSize: '0.875rem', fontWeight: 600, textDecoration: 'none', ...ar,
            }}>
              {t.nav.hire}
            </a>
          </div>
