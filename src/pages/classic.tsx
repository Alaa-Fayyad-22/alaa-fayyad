...
/**
 * The original terminal-style design, preserved verbatim at `/classic`. The
 * homepage (`/`) is now the IDE-workspace design; this route keeps the old one
 * working standalone (its own BootOverlay, SmoothScroll, SiteNav, five
 * ScreenFrame sections and Footer, backed by the global stylesheet in
 * _document.tsx).
 */
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${SITE_URL}/classic`} />
        ...
        <meta property="og:url" content={`${SITE_URL}/classic`} />
      ...
      {/* Back to the current (IDE-workspace) homepage. */}
      <div style={{ textAlign: 'center', padding: '0 0 40px' }}>
        <Link href="/" style={{ fontFamily: 'var(--font-mono), monospace', fontSize: '0.8rem', color: 'var(--text-muted)' }}>
          ← workspace view
        </Link>
      </div>
